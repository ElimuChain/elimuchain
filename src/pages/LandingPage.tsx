          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-on-scroll">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                Securely issue, manage, and verify academic credentials with
                ElimuChain—the future of trust in education.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-on-scroll">
            <h2 className="text-3xl font-bold mb-4 gradient-text">
              Why Choose ElimuChain?
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Experience the future of academic credentials with our innovative
              blockchain solution.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                ...
                description:
                  "Bank-grade security ensures your credentials are tamper-proof and forever verifiable.",
              },
              {
                icon: Zap,
                title: "Instant Verification",
                description:
                  "Verify credentials in seconds, not days, with our blockchain-powered platform.",
              },
              {
                icon: Globe2,
                title: "Global Access",
                description:
                  "Access and share your credentials anywhere, anytime, with anyone.",
              },
            ].map((feature, index) => (
            ...
            {[
              {
                ...
                description:
                  "Institutions securely issue digital credentials on the blockchain",
              },
              {
                icon: Shield,
                title: "Store Securely",
                description:
                  "Credentials are stored immutably with bank-grade security",
              },
              {
                icon: CheckCircle2,
      ...
      <section id="benefits" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-on-scroll">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              ElimuChain provides value for all stakeholders in the education
              ecosystem
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                quote:
                  "ElimuChain has revolutionized how we handle academic credentials. The efficiency and security are unmatched.",
                author: "Dr. Sarah Kinoti",
                role: "Dean of Admissions, Nairobi University",
              },
              {
                quote:
                  "The verification process that used to take weeks now takes seconds. It's transformed our recruitment process.",
